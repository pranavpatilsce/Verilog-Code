...
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { m }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
...
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { overflow }]; #IO_L17P_T2_A14_D30_14 Sch=led[6]

#set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { out[4] }]; #IO_L9P_T1_DQS_14 Sch=btn